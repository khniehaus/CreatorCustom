...
_pkg_config = {
    'pyqt_bin_dir':      'PyQt4/BINDIR',
    'pyqt_config_args':  '-b BINDIR -d DESTDIR -p PLUGDIR -v SIPDIR',
    'pyqt_mod_dir':      'PyQt4/DESTDIR/PyQt4',
